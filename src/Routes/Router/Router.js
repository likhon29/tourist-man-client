...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        // loader: () => fetch('https://tourist-man-server.vercel.app/allServices')
      },
      {
        path: "/service/:id",
        element: <ServiceDetails></ServiceDetails>,
        loader: ({ params }) =>
          fetch(`https://tourist-man-server.vercel.app/services/${params.id}`),
      },
      {
        path: "/reviews",
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://tourist-man-server.vercel.app/myReview/${params.id}`),
      },
      {
        path: "/addServices",
        element: (
